...
/**
 * PublicApiGetLockLogsResult Class Doc Comment
 *
 * @category Class
 ...
 */
class PublicApiGetLockLogsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicApiGetLockLogsResult';
    ...
    protected static $openAPITypes = [
        'lock_logs' => '\OpenAPI\Client\Model\PublicApiDeviceLogData[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets lock_logs
     *
     * @return \OpenAPI\Client\Model\PublicApiDeviceLogData[]|null
     */
     ...
     * Sets lock_logs
     *
     * @param \OpenAPI\Client\Model\PublicApiDeviceLogData[]|null $lock_logs Device logs. Currently maximum of 2000 is returned at once.
     *
     * @return self
     */
